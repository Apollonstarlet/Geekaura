...
import '../model/option_category.dart';
import '../model/sport_category.dart';
import '../model/sport_field.dart';
import '../model/user.dart';

var _reserve = OptionCategory(
  name: "Reserve",
  image: "assets/icons/reserve.png",
);
var _search = OptionCategory(
  name: "Look for a group",
  image: "assets/icons/search.png",
);
var _create = OptionCategory(
  name: "Create a group",
  image: "assets/icons/create.png",
);
var _groups = OptionCategory(
  name: "My groups",
